...
PM_data <- dnam %>% dplyr::select(ID, pct_5mC, prop_5mC, PM_5yrPreSamp, PM_1yrPreSamp, PM_6moPreSamp, PM_3moPreSamp, PM_1moPreSamp, SO4_5yrPreSamp, SO4_1yrPreSamp, SO4_6moPreSamp, SO4_3moPreSamp, SO4_1moPreSamp, NO3_5yrPreSamp, NO3_1yrPreSamp, NO3_6moPreSamp, NO3_3moPreSamp, NO3_1moPreSamp, NH4_5yrPreSamp, NH4_1yrPreSamp, NH4_6moPreSamp, NH4_3moPreSamp, NH4_1moPreSamp, BC_5yrPreSamp, BC_1yrPreSamp, BC_6moPreSamp, BC_3moPreSamp, BC_1moPreSamp, OM_5yrPreSamp, OM_1yrPreSamp, OM_6moPreSamp, OM_3moPreSamp, OM_1moPreSamp, SS_5yrPreSamp, SS_1yrPreSamp, SS_6moPreSamp, SS_3moPreSamp, SS_1moPreSamp, Soil_5yrPreSamp, Soil_1yrPreSamp, Soil_6moPreSamp, Soil_3moPreSamp, Soil_1moPreSamp)

write_xlsx(PM_data, "Simmons_PM25andConstituentMatching_MethylFlash_2022_07_14.xlsx")
```
...
## Scatterplots
### Scatterplot Matrix
PM2.5 and other pollutants in 1yr pre-censoring
```{r}
colnames(dnam)
ggpairs(dnam, columns=c(6, 63, 68, 73, 78, 83, 88, 93, 98))
```

PM2.5 SO4, NO3, NH4 in 1yr pre-censoring
```{r}
ggpairs(dnam, columns=c(6, 63, 68, 73, 78))
```
...
(dnamb %>% ggplot(aes(x=NH43moSamp_dich, y=pct_5mC, fill=NH43moSamp_dich))+
    ...
    ylim(0,0.5))
```
pct_5mC appears higher in the high NH41yrSamp_dich exposure group.
...
plot(dnam_model1)
```
**Higher PM_5yrPreSamp assoc with increased prop_5mC in this model.**
...
nobs(dnam_model1)
```
*Higher PM_5yrPreSamp marginally assoc with increased prop_5mC in this model.*
...
Complete model with age_dx, sex, smokeHx, race, urbanicity
```{r}
dnam_model3 <- betareg(prop_5mC ~ PM5yrSamp_dich + sex + age_dx + smokeHx + dich_Race + metro, data=dnam)
summary(dnam_model3)
confint(dnam_model3)  
nobs(dnam_model3)
```
...
Complete model with age_dx, sex, smokeHx, race, urbanicity
```{r}
dnam_model3 <- betareg(prop_5mC ~ PM6moSamp_dich + sex + age_dx + smokeHx + dich_Race + metro, data=dnam)
summary(dnam_model3)
confint(dnam_model3)  
nobs(dnam_model3)
```
...
nobs(dnam_model1)
```
**Significant association between PM_1moPreSamp and increased prop_5mC in this model.**
...
Complete model with age_dx, sex, smokeHx, race, urbanicity
```{r}
dnam_model3 <- betareg(prop_5mC ~ PM1moSamp_dich + sex + age_dx + smokeHx + dich_Race + metro, data=dnam)
summary(dnam_model3)
confint(dnam_model3)  
nobs(dnam_model3)
```
...
nobs(dnam_model1)
```
**Significant association between SO4_5yrPreSamp and increased prop_5mC in this model.**
...
nobs(dnam_model1)
```
**Significant association between SO4_6moPreSamp and increased prop_5mC in this model.**
...
nobs(dnam_model1)
```
**Significant association between SO4_1moPreSamp and increased prop_5mC in this model.**
...
nobs(dnam_model1)
```
No significant association between NO3_5yrPreSamp and prop_5mC in this model.
...
nobs(dnam_model1)
```
No significant association between NO35yrSamp_dichHigh and prop_5mC in this model.
...
nobs(dnam_model1)
```
No significant association between NO3_6moPreSamp and prop_5mC in this model.
...
nobs(dnam_model1)
```
No significant association between NO3_1moPreSamp and prop_5mC in this model.
...
nobs(dnam_model1)
```
No significant association between NH45yrSamp_dich and prop_5mC in this model.
...
nobs(dnam_model1)
```
*Marginal association between BC_5yrPreSamp and higher prop_5mC in this model.*
...
nobs(dnam_model1)
```
**Significant association between BC_6moPreSamp and higher prop_5mC in this model.**
...
nobs(dnam_model2)
```
*Marginal association between BC_6moPreSamp and higher prop_5mC in this model.*
...
nobs(dnam_model1)
```
**Significant association between BC6moSamp_dichHigh and higher prop_5mC in this model.**
...
nobs(dnam_model2)
```
*Marginal association between BC6moSamp_dichHigh and higher prop_5mC in this model.*
...
nobs(dnam_model1)
```
**Significant association between BC_1moPreSamp and higher prop_5mC in this model.**
...
nobs(dnam_model1)
```
**Significant association between BC1moSamp_dichHigh and higher prop_5mC in this model.**
...
nobs(dnam_model2)
```
*Marginal association between BC1moSamp_dichHigh and higher prop_5mC in this model.*
...
nobs(dnam_model1)
```
**Significant association between OM5yrSamp_dichHigh and higher prop_5mC in this model.**
...
nobs(dnam_model2)
```
*Marginal association between OM5yrSamp_dichHigh and higher prop_5mC in this model.*
...
nobs(dnam_model1)
```
*Marginal association between SS_5yrPreSamp and higher prop_5mC in this model.*
...
nobs(dnam_model1)
```
*Marginal association between SS5yrSamp_dichHigh and higher prop_5mC in this model.*
...
nobs(dnam_model1)
```
No association between high SS6moSamp_dich and prop_5mC in this model.
...
```
Very few patients in the low exposure group, but the curve is clearly higher.
...
summary(coxPH_model1)
```
**Significant assoc between higher PM_5yrPreSamp and increased mortality in this model.**
...
summary(coxPH_model1)
```
**Significant assoc between higher PM_5yrPreSamp and increased mortality in this model with slight reduction in HR by introduction of pct_5mC to mode, suggesting small amount of mediation.**
...
summary(coxPH_model2)
```
**Significant assoc between higher PM_5yrPreSamp and increased mortality in this model with slight reduction in HR by introduction of pct_5mC to model, suggesting small amount of mediation.**
...
summary(coxPH_model1)
```
**Significant assoc between increased PM_6moPreSamp and increased mortality in this model.**
...
summary(coxPH_model1)
```
**Significant assoc between increased PM_6moPreSamp and increased mortality in this model, and HR decreases slightly when pct_5mC added indicating that DNAm may mediate a portion of the assoc between PM2.5 and mort.**
...
```
High exposure curve is clearly lower.
...
summary(coxPH_model1)
```
**Significant assoc between increased PM_1moPreSamp and increased mortality in this model.**
...
summary(coxPH_model1)
```
**Significant assoc between increased PM_1moPreSamp and increased mortality in this model, and HR decreases slightly when pct_5mC added indicating that DNAm may mediate a portion of the assoc between PM2.5 and mort.**
...
```
Very few patients in the low exposure group, but clearly the high exposure curve is lower.
...
summary(coxPH_model1)
```
**Significant assoc between SO4_5yrPreSamp and increased mortality in this model.**
...
summary(coxPH_model1)
```
**Significant assoc between SO4_5yrPreSamp and increased mortality in this model, and the HR decreases with the addition of pct_5mC to the models indicating that global DNAm may mediate a portion of the SO4 and mortality association.**
...
summary(coxPH_model3)
```
No significant assoc between SO4_5yrPreSamp and mortality in this model.
...
summary(coxPH_model1)
```
**Significant assoc between higher SO4_6moPreSamp and increased mortality in this model.**
...
summary(coxPH_model1)
```
**Significant assoc between higher SO4_6moPreSamp and increased mortality in this model, and HR decreases when pct_5mC added indicating that DNAm may mediate a portion of the SO4-mortality association.**
...
summary(coxPH_model1)
```
**Significant assoc between higher SO4_1moPreSamp and increased mortality in this model.**
...
summary(coxPH_model1)
```
**Significant assoc between higher SO4_1moPreSamp and increased mortality in this model, and HR decreases when pct_5mC added indicating that DNAm may mediate a portion of the SO4-mortality association.**
...
```
High exposure curve appears slightly lower.
...
summary(coxPH_model1)
```
**Significant assoc between higher NO3_5yrPreSamp and increased mortality in this model.**
...
```
**Significant assoc between higher NO3_5yrPreSamp and increased mortality in this model.**
HR increases with pct_5mC addition to model, indicating DNAm not mediating this association.
...
```
No clear separation of the curves.
...
```
Very few patients in the low exposure group, but the high exposure curve clearly lower.
...
summary(coxPH_model1)
```
**Significant assoc between NH4_5yrPreSamp and increased mortality in this model.**
...
summary(coxPH_model1)
```
**Significant assoc between NH4_5yrPreSamp and increased mortality in this model, with reduction in HR when pct_5mC added to model indicating component of mediation by DNAm.**
...
summary(coxPH_model3)
```
No significant assoc between NH4_5yrPreSamp and mortality in this model.
...
summary(coxPH_model1)
```
**Significant assoc between NH4_6moPreSamp and increased mortality in this model.**
...
summary(coxPH_model1)
```
**Significant assoc between NH4_6moPreSamp and increased mortality in this model, with reduction in HR when pct_5mC added to model indicating component of mediation by DNAm.**
...
summary(coxPH_model1)
```
**Significant assoc between NH4_1moPreSamp and increased mortality in this model.**
...
summary(coxPH_model1)
```
**Significant assoc between NH4_1moPreSamp and increased mortality in this model, with reduction in HR when pct_5mC added to model indicating component of mediation by DNAm.**
...
```
High exposure curve slightly lower.
...
summary(coxPH_model3)
```
*Marginal assoc between increased BC_1moPreSamp and lower mortality in this model.*
HR decreases when pct_5mC added to model indicating some mediation.
...
```
High exposure curve appears lower.
...
summary(coxPH_model1)
```
**Significant assoc between higher OM_5yrPreSamp and increased mortality in this model.**
...
```
**Significant assoc between higher OM_5yrPreSamp and increased mortality in this model.**
HR increases when pct_5mC added indicating that it is not mediating the OM-mortality association.
...
summary(coxPH_model3)
```
**Significant assoc between higher OM_6moPreSamp and lower mortality in this model.**
...
summary(coxPH_model3)
```
**Significant assoc between higher OM_6moPreSamp and lower mortality in this model with slight reduction in HR when pct_5mC added indicating some mediation effect.**
...
summary(coxPH_model1)
```
No assoc between higher OM_1moPreSamp and mortality in this model.
...
summary(coxPH_model3)
```
**Significant assoc between higher OM_1moPreSamp and lower mortality in this model.**
...
summary(coxPH_model3)
```
**Significant assoc between higher OM_1moPreSamp and lower mortality in this model with slight decrease HR with pct_5mC addition indicating some mediation.**
...
summary(coxPH_model1)
```
**Significant assoc between higher SS_5yrPreSamp and increased mortality in this model.**
...
summary(coxPH_model1)
```
**Significant assoc between higher SS_5yrPreSamp and increased mortality in this model wth HR reduction when pct_5mC added indicating some mediation effect.**
...
summary(coxPH_model2)
```
**Significant assoc between higher SS_5yrPreSamp and increased mortality in this model with HR reduction when pct_5mC added indicating some mediation effect.**
...
```
*Marginal assoc between increased Soil in 5yrs pre-sampling and increased mortality in this model.*
HR increased when pct_5mC added to model, indicating no mediation.
...
summary(coxPH_model2)
```
No assoc between increased Soil in 5yrs pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
No assoc between increased Soil_6moPreSamp and mortality in this model.
...
summary(coxPH_model2)
```
*Marginal assoc between Soil_1moPreSamp and lower mortality in this model.*
...
summary(coxPH_model3)
```
**Significant assoc between higher Soil_1moPreSamp and lower mortality in this model.**
...
summary(coxPH_model3)
```
**Significant assoc between higher Soil_1moPreSamp and lower mortality in this model with HR reduced when pct_5mC added indicating some slight mediation.**
