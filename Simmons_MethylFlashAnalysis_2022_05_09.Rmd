...
summary(coxPH_model2)
```
**HR for PM_3moPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model3)
```
**Significance assoc between PM_3moPreSamp and mort in this model.**
...
summary(coxPH_model3)
```
**Significance assoc between PM_1moPreSamp and mort in this model.**
...
summary(coxPH_model3)
```
*Marginal assoc between SO4_1moPreSamp and mort in this model.*
...
summary(coxPH_model3)
```
*HR for SO4_1moPreSamp decreases very slightly in this model indicating some mediation by pct_5mC*
...
summary(coxPH_model3)
```
**Sig assoc between higher NO3_5yrPreSamp and mort in this model.**
...
summary(coxPH_model3)
```
No clear difference in the NO3 HR in this complete model.
...
summary(coxPH_model3)
```
*Marginal assoc between higher NO3_1yrPreSamp and increased mort in this model.*
...
summary(coxPH_model1)
```
*Marginal association between higher NO3 in 6mo pre-sampling and mortality in this model.*
...
summary(coxPH_model2)
```
HR for NO3_6moPreSamp decreases slightly in this model, but not significant
...
summary(coxPH_model3)
```
Significance for NO3 assoc with mortality lost in this model, likely because the primary impact is on baseline lung function, and the later NO3 impact on mortality is from the 5yr pre-censoring time period.
...
summary(coxPH_model3)
```
Slight decrease NO3 HR in this complete model, but not significant.
...
summary(coxPH_model3)
```
No clear difference in the NH4 HR in this complete model.
...
summary(coxPH_model3)
```
NH4 HR decreases slightly but is not significant in this complete model.
...
summary(coxPH_model3)
```
HR for NH4_3moPreSamp decreases slightly in this model but is not significant
...
summary(coxPH_model3)
```
HR for NH4_1moPreSamp decreases slightly but is not significant in this model.
...
summary(coxPH_model2)
```
No sig assoc between BC and mortality in this model, **although pct_5mC becomes significant indicating that higher pct_5mC assoc with increased mort.**
...
summary(coxPH_model2)
```
**HR for BC_3moPreSamp decreases slightly in this model and the impact of pct_5mC on mortality becomes significant indicating some mediation by pct_5mC**
...
summary(coxPH_model1)
```
**HR for BC_1moPreSamp decreases slightly in this model and the impact of pct_5mC on mortality becomes significant indicating some mediation by pct_5mC**
...
summary(coxPH_model2)
```
**HR for BC_1moPreSamp decreases slightly in this model and the impact of pct_5mC on mort becomes significant indicating some mediation by pct_5mC**
...
summary(coxPH_model3)
```
No sig assoc in this complete model.
...
summary(coxPH_model1)
```
*Marginal association between higher OM in 5yrs pre-censoring and mortality in this model.*
...
summary(coxPH_model3)
```
HR for OM actually increases in this model when pct_5mC included, arguing against any pct_5mC mediation of this association.
...
summary(coxPH_model2)
```
Minimal diff in HR for OM_1yrPreSamp when pct_5mC included in this model.
...
summary(coxPH_model1)
```
HR for OM_6moPreSamp decreases slightly in this model indicating some mediation by pct_5mC, but OM still not sig assoc with mort
...
summary(coxPH_model2)
```
HR for OM_3moPreSamp decreases slightly in this model indicating some mediation by pct_5mC, but OM still not sig assoc with mort.
...
summary(coxPH_model1)
```
**HR for OM_1moPreSamp decreases slightly in this model indicating some mediation by pct_5mC and the assoc between pct_5mC and mort becomes significant**
...
summary(coxPH_model2)
```
**HR for OM_1moPreSamp decreases slightly in this model indicating some mediation by pct_5mC and the impact of pct_5mC on mort becomes signifcant**
...
summary(coxPH_model1)
```
HR for SS_1yrPreSamp increases slightly in this model indicating it is not mediated by pct_5mC
...
summary(coxPH_model3)
```
SS HR increases in this complete model, indicating pct_5mC does not mediate SS and mort assoc.
...
summary(coxPH_model1)
```
HR for SS_1yrPreSamp increases slightly in this model indicating any assoc is NOT mediated by pct_5mC
...
summary(coxPH_model1)
```
HR for SS_6moPreSamp increases in this model indicating no mediation by pct_5mC
...
summary(coxPH_model2)
```
**pct_5mC sig assoc with mort in this model.**
...
summary(coxPH_model1)
```
**Sig association between higher Soil in 5yrs pre-censoring and mortality in this model.**
...
summary(coxPH_model2)
```
**Sig association between higher Soil_5yrPreSamp and mortality in this model.**
...
summary(coxPH_model3)
```
Soil HR increases, indicating pct_5mC not mediating any assoc
...
summary(coxPH_model1)
```
**Sig association between higher Soil in 1yr pre-sampling and mortality in this model.**
...
summary(coxPH_model2)
```
**Sig association between higher Soil_1yrPreSamp and mortality in this model.**
...
summary(coxPH_model1)
```
*HR for Soil_6moPreSamp decreases slightly in this model indicating some mediation by pct_5mC*
...
summary(coxPH_model2)
```
*HR for Soil_3moPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model1)
```
HR for Soil_1moPreSamp decreases slightly in this model indicating some mediation by pct_5mC, but impact of soil on mort still not significant.
**Assoc between pct_5mC and mort becomes significant.**
...
summary(coxPH_model2)
```
*HR for Soil_1moPreSamp decreases slightly in this model indicating some mediation by pct_5mC, and higher soil marginally assoc with lower mort in this model.*
**Higher pct_5mC becomes significantly assoc with incr mort in this model.**
...
summary(coxPH_model3)
```
No sig diff in HR for Soil_1moPreSamp indicating minimal mediation by pct_5mC
