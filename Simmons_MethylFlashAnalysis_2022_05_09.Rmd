...
```{r}
write_xlsx(dnam, path="Simmons_fILD_PM25andConstituentsMatched_forMethylFlash_2022_06_03.xlsx")
```
...
confint(dnam_model1)
```
**Higher PM2.5 in 5yrs pre-sampling associated with higher 5mC in this model.**
...
confint(dnam_model1)
```
*Higher PM2.5 in 5yrs pre-sampling marginally associated with higher 5mC in this model.*
...
confint(dnam_model1)
```
**Higher PM2.5 in 1yr pre-sampling associated with higher 5mC in this model.**
...
confint(dnam_model1)
```
*Higher PM2.5 in 1yr pre-sampling marginally associated with higher 5mC in this model.*
...
confint(dnam_model1)
```
**Higher PM2.5 in 3mo pre-sampling associated with higher 5mC in this model.**
...
confint(dnam_model3)
```
*Higher PM2.5 in 3mo pre-sampling marginally associated with higher 5mC in this model.*
...
confint(dnam_model1)
```
**Significant association between SO4_5yrPreSamp and higher prop_5mC in this model.**
...
confint(dnam_model1)
```
**Significant association between SO4_1yrPreSamp and higher prop_5mC in this model.**
...
confint(dnam_model1)
```
**Significant association between SO4_6moPreSamp and higher prop_5mC in this model.**
...
confint(dnam_model1)
```
**Significant association between NH4_5yrPreSamp and higher prop_5mC in this model.**
...
confint(dnam_model1)
```
**Significant association between NH4_6moPreSamp and higher prop_5mC in this model.**
...
confint(dnam_model1)
```
**Significant association between NH4_1moPreSamp and higher prop_5mC in this model.**
...
confint(dnam_model1)
```
*Marginal association between higher BC_5yrPreSamp and higher prop_5mC in this model.*
...
confint(dnam_model1)
```
**Significant association between higher BC_1yrPreSamp and higher prop_5mC in this model.**
...
confint(dnam_model1)
```
**Significant association between higher BC_6moPreSamp and higher prop_5mC in this model.**
...
confint(dnam_model2)
```
*Marginal association between higher BC_6moPreSamp and higher prop_5mC in this model.*
...
confint(dnam_model1)
```
**Significant association between higher BC_3moPreSamp and higher prop_5mC in this model.**
...
confint(dnam_model1)
```
**Significant association between higher BC_1moPreSamp and higher prop_5mC in this model.**
...
confint(dnam_model1)
```
*Marginal association between higher SS_5yrPreSamp and higher prop_5mC in this model.*
...
summary(coxPH_model1)
```
No association between higher %5mC and mortality in this model.
...
## PM2.5 in 6mo Pre-Sampling Models
Base model with just PM2.5
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ PM_6moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher PM2.5 in 6mo pre-sampling and mortality in this model.**
...
summary(coxPH_model1)
```
*HR for PM_6moPreSamp decreases very slightly in this model indicating some mediation by pct_5mC*
...
summary(coxPH_model2)
```
**Sig association between higher PM_6moPreSamp and mortality in this model.**
...
summary(coxPH_model2)
```
*HR for PM_6moPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
## PM2.5 in 3mo Pre-Sampling Models
Base model with just PM2.5
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ PM_3moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher PM2.5 in 3mo pre-sampling and mortality in this model.**
...
summary(coxPH_model2)
```
**Sig association between higher PM_3moPreSamp and mortality in this model.**
...
summary(coxPH_model2)
```
*HR for PM_3moPreSamp decreases very slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model3)
```
No assoc between PM_3moPreSamp and mort in this model.
...
## PM2.5 in 1mo Pre-Sampling Models
Base model with just PM2.5
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ PM_1moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher PM2.5 in 1mo pre-sampling and mortality in this model.**
...
summary(coxPH_model1)
```
*HR for PM_1moPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model2)
```
**Sig association between higher PM_1moPreSamp and mortality in this model.**
...
summary(coxPH_model2)
```
*HR for PM_1moPreSamp decreases very slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model3)
```
No assoc between PM_1moPreSamp and mort in this model.
...
## SO4 in 5yrs Pre-Sampling Models
Base model with just SO4
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SO4_5yrPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher SO4 in 5yrs pre-censoring and mortality in this model.**
...
summary(coxPH_model1)
```
No assoc between higher %5mC and mortality in this model.
...
summary(coxPH_model1)
```
**HR for SO4_1yrPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model2)
```
**Sig association between higher SO4_5yrPreSamp and mortality in this model.**
...
summary(coxPH_model3)
```
No sig assoc between SO4_5yrPreSamp and mortality in this model, likely because the mortality impact is largely based on SO4 impact on baseline FVC and DLCO. The impact on mortality itself is most pronounced in the 5yr pre-censoring time period, which doesn't make sense to evaluate in the DNAm analyses where the reference date is the sample date.
...
summary(coxPH_model3)
```
No clear difference in the SO4 HR in this complete model.

## SO4 in 1yr Pre-Sampling Models
Base model with just SO4
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SO4_1yrPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher SO4 in 1yr pre-sampling and mortality in this model.**
...
summary(coxPH_model2)
```
**Sig association between higher SO4_1yrPreSamp and mortality in this model.**
...
summary(coxPH_model3)
```
Significance for SO4 assoc with mortality lost in this model, likely because the primary impact is on baseline lung function, and the later SO4 impact on mortality is from the 5yr pre-censoring time period.
...
## SO4 in 6mo Pre-Sampling Models
Base model with just SO4
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SO4_6moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher SO4 in 6mo pre-sampling and mortality in this model.**
...
summary(coxPH_model1)
```
**HR for SO4_6moPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model2)
```
**Sig association between higher SO4_6moPreSamp and mortality in this model.**
...
## SO4 in 3mo Pre-Sampling Models
Base model with just SO4
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SO4_3moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher SO4 in 3mo pre-sampling and mortality in this model.**
...
summary(coxPH_model2)
```
**Sig association between higher SO4_3moPreSamp and mortality in this model.**
...
summary(coxPH_model2)
```
**HR for SO4_3moPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model3)
```
No sig assoc between SO4_3moPreSamp and mort in this model.
...
## SO4 in 1mo Pre-Sampling Models
Base model with just SO4
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SO4_1moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher SO4 in 1mo pre-sampling and mortality in this model.**
...
summary(coxPH_model1)
```
**HR for SO4_1moPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model2)
```
**Sig association between higher SO4_1moPreSamp and mortality in this model.**
...
summary(coxPH_model3)
```
No assoc between SO4_1moPreSamp and mort in this model.
...
## NO3 in 5yrs Pre-Sampling Models
Base model with just NO3
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NO3_5yrPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher NO3 in 5yrs pre-censoring and mortality in this model.**
...
summary(coxPH_model1)
```
*HR for NO3_1yrPreSamp decreases very slightly in this model indicating some mediation by pct_5mC*
...
summary(coxPH_model2)
```
**Sig association between higher NO3_5yrPreSamp and mortality in this model.**
...
summary(coxPH_model2)
```
HR for NO3_1yrPreSamp does not decrease in this model indicating no mediation by pct_5mC.
...
summary(coxPH_model3)
```
No assoc between higher NO3_5yrPreSamp and mort in this model.
...
summary(coxPH_model3)
```
*HR for NO3_5yrPreSamp decreases very slightly in this model indicating some mediation by pct_5mC*

## NO3 in 1yr Pre-Sampling Models
Base model with just NO3
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NO3_1yrPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher NO3 in 1yr pre-sampling and mortality in this model.**
...
summary(coxPH_model1)
```
**HR for NO3_1yrPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model2)
```
**Sig association between higher NO3_1yrPreSamp and mortality in this model.**
...
summary(coxPH_model3)
```
No assoc between higher NO3_1yrPreSamp and increased mort in this model.
...
## NO3 in 6mo Pre-Sampling Models
Base model with just NO3
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NO3_6moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No association between higher NO3 in 6mo pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
*HR for NO3_6moPreSamp decreases slightly in this model indicating some mediation by pct_5mC*
...
summary(coxPH_model2)
```
No association between higher NO3_6moPreSamp and mortality in this model.
...
summary(coxPH_model2)
```
*HR for NO3_6moPreSamp decreases very slightly in this model indicating some mediation by pct_5mC*
...
summary(coxPH_model3)
```
No sig assoc between NO3_6moPreSamp and mort in this model.
...
## NO3 in 3mo Pre-Sampling Models
Base model with just NO3
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NO3_3moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher NO3 in 3mo pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
*HR for NO3_3moPreSamp decreases very slightly in this model indicating some mediation by pct_5mC*
...
## NO3 in 1mo Pre-Sampling Models
Base model with just NO3
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NO3_1moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher NO3 in 1mo pre-sampling and mortality in this model.
...
## NH4 in 5yrs Pre-Sampling Models
Base model with just NH4
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NH4_5yrPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher NH4 in 5yrs pre-censoring and mortality in this model.**
...
summary(coxPH_model1)
```
**HR for NH4_1yrPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model2)
```
**Sig association between higher NH4_5yrPreSamp and mortality in this model.**
...
summary(coxPH_model3)
```
No sig assoc between NH4_5yrPreSamp and mortality in this model, likely because the mortality impact is largely based on NH4 impact on baseline FVC and DLCO. The impact on mortality itself is most pronounced in the 5yr pre-censoring time period, which doesn't make sense to evaluate in the DNAm analyses where the reference date is the sample date.
...
summary(coxPH_model3)
```
*HR for NH4_5yrPreSamp decreases very slightly in this model indicating some mediation by pct_5mC*

## NH4 in 1yr Pre-Sampling Models
Base model with just NH4
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NH4_1yrPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher NH4 in 1yr pre-sampling and mortality in this model.**
...
summary(coxPH_model2)
```
**Sig association between higher NH4_1yrPreSamp and mortality in this model.**
...
summary(coxPH_model3)
```
Significance for NH4 assoc with mortality lost in this model, likely because the primary impact is on baseline lung function, and the later NH4 impact on mortality is from the 5yr pre-censoring time period.
...
summary(coxPH_model3)
```
*HR for NH4_1yrPreSamp decreases very slightly in this model indicating some mediation by pct_5mC*

## NH4 in 6mo Pre-Sampling Models
Base model with just NH4
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NH4_6moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher NH4 in 6mo pre-sampling and mortality in this model.**
...
summary(coxPH_model1)
```
**HR for NH4_6moPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model2)
```
**Sig association between higher NH4_6moPreSamp and mortality in this model.**
...
summary(coxPH_model3)
```
*HR for NH4_6moPreSamp decreases very slightly in this model indicating some mediation by pct_5mC*


## NH4 in 3mo Pre-Sampling Models
Base model with just NH4
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NH4_3moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher NH4 in 3mo pre-sampling and mortality in this model.**
...
summary(coxPH_model2)
```
**Sig association between higher NH4_3moPreSamp and mortality in this model.**
...
summary(coxPH_model2)
```
**HR for NH4_3moPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model3)
```
No sig assoc between NH4_3moPreSamp and mort in this model.
...
## NH4 in 1mo Pre-Sampling Models
Base model with just NH4
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NH4_1moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher NH4 in 1mo pre-sampling and mortality in this model.**
...
summary(coxPH_model1)
```
**HR for NH4_1moPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model2)
```
**Sig association between higher NH4_1moPreSamp and mortality in this model.**
...
summary(coxPH_model3)
```
No sig assoc between NH4_1moPreSamp and mort in this model.
...
## BC in 5yrs Pre-Sampling Models
Base model with just BC
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ BC_5yrPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher BC in 5yrs pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
HR for BC_1yrPreSamp decreases slightly in this model indicating some mediation by pct_5mC, but still not significant
...
summary(coxPH_model2)
```
HR for BC_1yrPreSamp decreases slightly in this model indicating some mediation by pct_5mC, but BC impact on mort not significant.
...
summary(coxPH_model3)
```
No sig assoc between BC_5yrPreSamp and mortality in this model
...
summary(coxPH_model3)
```
No clear difference in the BC HR in this complete model.

## BC in 1yr Pre-Sampling Models
Base model with just BC
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ BC_1yrPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher BC in 1yr pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
HR for BC_1yrPreSamp decreases slightly in this model indicating some mediation by pct_5mC, but model still not sig for BC impact on mort
...
summary(coxPH_model2)
```
No sig association between higher BC_1yrPreSamp and mortality in this model.
...
summary(coxPH_model3)
```
No sig assoc between BC and mort in this complete model.
...
## BC in 6mo Pre-Sampling Models
Base model with just BC
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ BC_6moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher BC in 6mo pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
HR for BC_6moPreSamp decreases slightly in this model indicating some mediation by pct_5mC, but model still not sig for BC impact on mort
...
summary(coxPH_model2)
```
No sig association between higher BC_6moPreSamp and mortality in this model.
...
summary(coxPH_model2)
```
No sig assoc between BC and mortality in this model
...
summary(coxPH_model3)
```
No sig assoc between BC and mort in this model.
...
## BC in 3mo Pre-Sampling Models
Base model with just BC
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ BC_3moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher BC in 3mo pre-sampling and mortality in this model.
...
summary(coxPH_model2)
```
No sig association between higher BC_3moPreSamp and mortality in this model.
...
summary(coxPH_model2)
```
HR for BC_3moPreSamp decreases slightly in this model indicating some mediation by pct_5mC.
...
summary(coxPH_model3)
```
No sig assoc between BC_3moPreSamp and mort in this model.
...
## BC in 1mo Pre-Sampling Models
Base model with just BC
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ BC_1moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher BC in 1mo pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
*HR for BC_1moPreSamp decreases slightly in this model and the impact of pct_5mC on mortality becomes marginally significant indicating some mediation by pct_5mC*
...
summary(coxPH_model2)
```
No sig association between higher BC_1moPreSamp and mortality in this model.
...
summary(coxPH_model2)
```
*HR for BC_1moPreSamp decreases slightly in this model and the impact of pct_5mC on mort becomes marginally significant indicating some mediation by pct_5mC*
...
summary(coxPH_model3)
```
No sig assoc between BC_1moPreSamp and mort in this model.
...
summary(coxPH_model3)
```
*Higher BC_1moPreSamp marginally assoc with lower mort in this model.*



## OM in 5yrs Pre-Sampling Models
Base model with just OM
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ OM_5yrPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher OM in 5yrs pre-censoring and mortality in this model.**
...
summary(coxPH_model1)
```
No major difference in HR for OM_1yrPreSamp in this model indicating minimal mediation by pct_5mC
...
summary(coxPH_model2)
```
**Sig association between higher OM_5yrPreSamp and mortality in this model.**
...
summary(coxPH_model2)
```
HR for OM_1yrPreSamp doesn't change in this model indicating no mediation by pct_5mC
...
summary(coxPH_model3)
```
No sig assoc between OM_5yrPreSamp and mortality in this model, likely because the mortality impact is largely based on OM impact on baseline FVC and DLCO. The impact on mortality itself is most pronounced in the 5yr pre-censoring time period, which doesn't make sense to evaluate in the DNAm analyses where the reference date is the sample date.
...
summary(coxPH_model3)
```
No clear evidence of mediation here.

## OM in 1yr Pre-Sampling Models
Base model with just OM
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ OM_1yrPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher OM in 1yr pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
No sig diff in HR for OM_1yrPreSamp when pct_5mC included in this model.
...
summary(coxPH_model2)
```
No sig association between higher OM_1yrPreSamp and mortality in this model.
...
summary(coxPH_model2)
```
Minimal increase in HR for OM_1yrPreSamp when pct_5mC included in this model.
...
summary(coxPH_model3)
```
No sig assoc between OM_1yrPreSamp and mort in this model.
...
summary(coxPH_model3)
```
No clear difference in the OM HR in this complete model.

## OM in 6mo Pre-Sampling Models
Base model with just OM
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ OM_6moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher OM in 6mo pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
No sig diff in HR for OM_6moPreSamp when pct_5mC included in model.
...
## OM in 3mo Pre-Sampling Models
Base model with just OM
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ OM_3moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher OM in 3mo pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
No significant change in HR in this model indicating minimal medication by pct_5mC.
...
## OM in 1mo Pre-Sampling Models
Base model with just OM
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ OM_1moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher OM in 1mo pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
No significant change in HR in this model indicating minimal medication by pct_5mC, *but pct_5mC assoc with increased mortality becomes marginally significant*.
...
summary(coxPH_model3)
```
**Sig association between higher OM_1moPreSamp and lower mortality in this model.**
...
summary(coxPH_model3)
```
*Very slight reduction in HR by pct_5mC indicating some small mediation effect.*



## SS in 5yrs Pre-Sampling Models
Base model with just SS
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SS_5yrPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
**Sig association between higher SS in 5yrs pre-censoring and mortality in this model.**
...
summary(coxPH_model1)
```
**HR for SS_5yrPreSamp decreases slightly in this model indicating it is partially mediated by pct_5mC.**
...
summary(coxPH_model2)
```
**Sig association between higher SS_5yrPreSamp and mortality in this model.**
...
summary(coxPH_model3)
```
No sig assoc between SS_5yrPreSamp and mortality in this model, likely because the mortality impact is largely based on SS impact on baseline FVC and DLCO. The impact on mortality itself is most pronounced in the 5yr pre-censoring time period, which doesn't make sense to evaluate in the DNAm analyses where the reference date is the sample date.
...
## SS in 1yr Pre-Sampling Models
Base model with just SS
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SS_1yrPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher SS in 1yr pre-sampling and mortality in this model.
...
summary(coxPH_model2)
```
*HR for SS_1yrPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model3)
```
*HR for SS_1yrPreSamp decreases slightly in this model indicating it is partially mediated by pct_5mC.*

## SS in 6mo Pre-Sampling Models
Base model with just SS
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SS_6moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher SS in 6mo pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
*HR for SS_6moPreSamp decreases slightly in this model indicating it is partially mediated by pct_5mC.*
...
summary(coxPH_model3)
```
No clear difference in the SS HR in this complete model.


## SS in 3mo Pre-Sampling Models
Base model with just SS
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SS_3moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher SS in 3mo pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
HR for SS_6moPreSamp increases slightly in this model indicating no mediation by pct_5mC
...
summary(coxPH_model2)
```
HR for SS_3moPreSamp increases slightly in this model indicating no mediation by pct_5mC
...
## SS in 1mo Pre-Sampling Models
Base model with just SS
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SS_1moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher SS in 1mo pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
HR for SS_1moPreSamp increases slightly in this model indicating no mediation by pct_5mC
...
summary(coxPH_model2)
```
*pct_5mC marginally assoc with mort in this model.*
...
## Soil in 5yrs Pre-Sampling Models
Base model with just Soil
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ Soil_5yrPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
*Marginal association between higher Soil_5yrPreSamp and mortality in this model.*
...
summary(coxPH_model1)
```
HR for Soil_1yrPreSamp increases slightly in this model indicating no mediation by pct_5mC
...
summary(coxPH_model2)
```
No association between higher Soil_5yrPreSamp and mortality in this model.
...
summary(coxPH_model3)
```
No sig assoc between Soil_5yrPreSamp and mortality in this model, likely because the mortality impact is largely based on Soil impact on baseline FVC and DLCO. The impact on mortality itself is most pronounced in the 5yr pre-censoring time period, which doesn't make sense to evaluate in the DNAm analyses where the reference date is the sample date.
...
summary(coxPH_model3)
```
No major difference in soil HR.

## Soil in 1yr Pre-Sampling Models
Base model with just Soil
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ Soil_1yrPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No association between higher Soil_1yrPreSamp and mortality in this model.
...
summary(coxPH_model1)
```
**HR for Soil_1yrPreSamp decreases slightly in this model indicating some mediation by pct_5mC**
...
summary(coxPH_model3)
```
Significance for Soil assoc with mortality lost in this model, likely because the primary impact is on baseline lung function, and the later Soil impact on mortality is from the 5yr pre-censoring time period.
...
summary(coxPH_model3)
```
No clear difference in the Soil HR in this complete model.

## Soil in 6mo Pre-Sampling Models
Base model with just Soil
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ Soil_6moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher Soil in 6mo pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
HR for Soil_6moPreSamp increases slightly in this model indicating no mediation by pct_5mC
...
summary(coxPH_model3)
```
Soil HR increases in this complete model when pct_5mC included, indicating that is not mediating any assoc between soil and mort.


## Soil in 3mo Pre-Sampling Models
Base model with just Soil
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ Soil_3moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher Soil in 3mo pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
No major difference in HR for Soil_3moPreSamp
...
summary(coxPH_model3)
```
**Significance assoc between Soil_3moPreSamp and lower mort in this model.**
...
summary(coxPH_model3)
```
HR for Soil_3moPreSamp largely unchanged, indicating assoc likely not mediated by pct_5mC

## Soil in 1mo Pre-Sampling Models
Base model with just Soil
```{r}
coxPH_model1 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ Soil_1moPreSamp, data=dnam, id=ID)
summary(coxPH_model1)
```
No sig association between higher Soil in 1mo pre-sampling and mortality in this model.
...
summary(coxPH_model1)
```
No major difference in HR for Soil_1moPreSamp
*Assoc between pct_5mC and mort becomes marginally significant.*
...
summary(coxPH_model2)
```
*Marginal association between higher Soil in 1mo pre-sampling and mortality in this model.*
...
summary(coxPH_model2)
```
No major difference in HR for Soil_6moPreSamp
*Higher pct_5mC becomes marginally assoc with incr mort in this model.*
...
summary(coxPH_model3)
```
**Significance assoc between Soil_1moPreSamp and lower mort in this model.**
...
summary(coxPH_model3)
```
*Slight decrease in HR for Soil_1moPreSamp indicating small portion of mediation by pct_5mC*
