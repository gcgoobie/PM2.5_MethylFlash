---
title: "Revision 1 PFF - MethylFlash Global DNAm Analysis"
...
```{r}
write_xlsx(dnam, path="PFF_fILD_PM25andConstituentsMatched_forMethylFlash_2022_11_07.xlsx")
```
...
n_prop_tbl(dnam$)
```
Overwhelming majority of the patients are considered "politan".
...
Histogram of time_DeathTxCensor
```{r}
(dnam %>% ggplot(aes(x=time_DeathTxCensor))+
   geom_histogram(fill="blue", color="black")+
   labs(x="time_DeathTxCensor", y="Number of patients with IPF", title="time_DeathTxCensor in Patients with IPF")+
   theme(plot.title = element_text(hjust = 0.5))+     scale_fill_manual(values=c("dodgerblue1", "firebrick1")))
```
Right-skewed distribution.
...
```{r}
dnam_model1 <- betareg(prop_5mC ~ PM_1yrPreSamp + site, dnam)
summary(dnam_model1)
confint(dnam_model1)  
nobs(dnam_model1)
```
...
Partial model with age_dx, sex, smokeHx, site
```{r}
dnam_model2 <- betareg(prop_5mC ~ PM_1yrPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Complete model with age_dx, sex, smokeHx, race, site
```{r}
dnam_model3 <- betareg(prop_5mC ~ PM_1yrPreSamp + sex + age_dx + smokeHx + dich_Race + site, data=dnam)
summary(dnam_model3)
confint(dnam_model3)  
nobs(dnam_model3)
```
...
Partial model with age_dx, sex, smokeHx, site
```{r}
dnam_model2 <- betareg(prop_5mC ~ PM1yrSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Complete model with age_dx, sex, smokeHx, race, site
```{r}
dnam_model3 <- betareg(prop_5mC ~ PM1yrSamp_dich + sex + age_dx + smokeHx + dich_Race + site, data=dnam)
summary(dnam_model3)
confint(dnam_model3)  
nobs(dnam_model3)
```
...
Partial model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ PM_3moPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Complete model with age_dx, sex, smokeHx, race, site
```{r}
dnam_model3 <- betareg(prop_5mC ~ PM_3moPreSamp + sex + age_dx + smokeHx + dich_Race + site, data=dnam)
summary(dnam_model3)
confint(dnam_model3)  
nobs(dnam_model3)
```
...
Partial model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ PM3moSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Complete model with age_dx, sex, smokeHx, race, site
```{r}
dnam_model3 <- betareg(prop_5mC ~ PM3moSamp_dich + sex + age_dx + smokeHx + dich_Race + site, data=dnam)
summary(dnam_model3)
confint(dnam_model3)  
nobs(dnam_model3)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ SO4_1yrPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
**Sig assoc between higher SO4_1yrPreSam and higher prop_5mC.**
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ SO41yrSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ SO4_3moPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ SO43moSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
nobs(dnam_model1)
```
**Significant association between higher NO3_1yrPreSamp and higher prop_5mC in this model.**

Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ NO3_1yrPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
nobs(dnam_model1)
```
**Sig association between high NO31yrSamp_dich and higher prop_5mC in this model.**

Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ NO31yrSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ NO3_3moPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ NO33moSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
nobs(dnam_model1)
```
*Marginal association between higher NH4_1yrPreSamp and higher prop_5mC in this model.*

Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ NH4_1yrPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
nobs(dnam_model1)
```
**Significant association between NH41yrSamp_dich and higher prop_5mC in this model.**

Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ NH41yrSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ NH4_3moPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ NH43moSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ BC_1yrPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ BC1yrSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ BC_3moPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ BC3moSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ OM_1yrPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ OM1yrSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ OM_3moPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ OM3moSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ SS_1yrPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ SS1yrSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
*Marginal association between SS1yrSamp_dich and higher prop_5mC in this model.*
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ SS_3moPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ SS3moSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ Soil_1yrPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ Soil1yrSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ Soil_3moPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
...
Adjusted model with age_dx, sex, smokeHx + site
```{r}
dnam_model2 <- betareg(prop_5mC ~ Soil3moSamp_dich + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_model2)
confint(dnam_model2)  
nobs(dnam_model2)
```
*Marginal association between Soil3moSamp_dich and higher prop_5mC in this model.*
...
Complete Model
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
...
summary(coxPH_model1)
```
No significant assoc between higher PM_1yrPreSamp and increased mortality in this model.
...
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ PM_1yrPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
**Significant assoc between PM_1yrPreSamp and increased mortality in this model.**

Complete Model with PM2.5 and pct_5mC
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ PM_1yrPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
*Adding pct_5mC to the model decreases the HR very slightly indicating some possible small amount of mediation of assoc between PM2.5 and mort.*
...
Complete Model with just PM2.5
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ PM_3moPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
**Significant assoc between PM_3moPreSamp and increased mortality in this model.**

Complete Model with PM2.5 and pct_5mC
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ PM_3moPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
No real change in HR with addition of pct_5mC indicating no major mediation.
...
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SO4_1yrPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
**Significant assoc between SO4_1yrPreSamp and increased mortality in this model.**

Complete Model with SO4 and pct_5mC
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SO4_1yrPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
**Slight decrease in HR with addition of pct_5mC to model indicating small amount of mediation.**
...
Complete Model with just SO4
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SO4_3moPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
**Significant assoc between SO4_3moPreSamp and increased mortality in this model.**

Complete Model with SO4 and pct_5mC
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SO4_3moPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
*Slight decrease in HR with addition of pct_5mC to model indicating possibly small degree of mediation, but SO4_3moPreSamp not significantly assoc with pct_5mC*
...
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NO3_1yrPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
...
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NO3_1yrPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
No significant assoc between NO3_1yrPreSamp and mortality in this model.
...
summary(coxPH_model1)
```
No major difference in HR with addition of pct_5mC to this model.
...
summary(coxPH_model2)
```
No major change in HR with addition of pct_5mC

Complete Model with just NO3
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NO3_3moPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
**Sig assoc between NO3_3moPreSamp and increased mortality in this model.**
...
Complete Model with NO3 and pct_5mC
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NO3_3moPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
No change in HR with addition of pct_5mC indicating no mediation.
...
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NH4_1yrPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
...
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NH4_1yrPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
No significant assoc between NH4_1yrPreSamp and mortality in this model.
...
Complete Model with just NH4
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NH4_3moPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
**Significant assoc between NH4_3moPreSamp and higher mortality in this model.**

Complete Model with NH4 and pct_5mC
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ NH4_3moPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
HR actually increases with addition of pct_5mC to model, indicating not mediating.
...
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ BC_1yrPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
**Significant assoc between BC_1yrPreSamp and increased mortality in this model.**

Complete Model with BC and pct_5mC
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ BC_1yrPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
*Slight decrease in HR with addition of pct_5mC indicating small degree of mediation.*
...
Complete Model with just BC
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ BC_3moPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
**Significant assoc between BC_3moPreSamp and increased mortality in this model.**

Complete Model with BC and pct_5mC
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ BC_3moPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
*Slight decrease in HR with addition of pct_5mC indicating small degree of mediation.*
...
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ OM_1yrPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
**Significant assoc between OM_1yrPreSamp and icnreased mortality in this model.**

Complete Model with OM and pct_5mC
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ OM_1yrPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
No change to HR with adding pct_5mC
...
summary(coxPH_model1)
```
*Marginal assoc between higher OM_3moPreSamp and increased mortality in this model.*
...
summary(coxPH_model1)
```
*Slight decrease in HR indicating small degree of mediation.*
...
Complete Model with just OM
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ OM_3moPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
**Sig assoc between higher OM_3moPreSamp and higher mortality in this model.**

Complete Model with OM and pct_5mC
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ OM_3moPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
No evidence of mediation.
...
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SS_1yrPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
No significant assoc between SS_1yrPreSamp and mortality in this model.
...
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SS_1yrPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
No significant assoc between SS_1yrPreSamp and mortality in this model.
...
Complete Model with just SS
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SS_3moPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
No significant assoc between SS_3moPreSamp and mortality in this model.
...
Complete Model with SS and pct_5mC
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ SS_3moPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
No significant assoc between SS_3moPreSamp and mortality in this model.
...
summary(coxPH_model1)
```
*Marginal assoc between increased Soil_1yrPreSamp and incr mortality in this model.*
...
summary(coxPH_model1)
```
HR decreases very slightly with addition of pct_5mC.
...
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ Soil_1yrPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
...
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ Soil_1yrPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
No assoc between increased Soil_1yrPreSamp and mortality in this model.
...
Complete Model with just Soil
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ Soil_3moPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
No significant association. 
...
Complete Model with Soil and pct_5mC
```{r}
coxPH_model3 <- coxph(Surv(time_DeathTxCensor, deadORtx==1) ~ Soil_3moPreSamp + pct_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam, id=ID)
summary(coxPH_model3)
```
No significant association. 
...
### Fully-Adjusted original model
Unadjusted linear model for assoc of SO4_1yrPreSamp with prop_5mC
```{r}
dnam_model1 <- lm(prop_5mC ~ SO4_1yrPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, dnam)
summary(dnam_model1)
confint(dnam_model1)  
```
...
```{r}
#survreg will NOT allow survival times that =0 because it uses a lognormal distribution, so there are five records whose time_DeathTxCensor=0, so we need to change those to a small number (i.e. 0.00001)

dnam <- dnam %>% mutate(time_DeathTxCensor_survreg = if_else(time_DeathTxCensor==0, 0.00001, time_DeathTxCensor))
```

```{r}
surv_model1 <- survreg(Surv(time_DeathTxCensor_survreg, deadORtx==1) ~ SO4_1yrPreSamp + prop_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnam)
summary(surv_model1)
```
...
summary(med1)
```
This mediation model will not run. The error reported is "Error in if (xhat == 0) out <- 1 else { : missing value where TRUE/FALSE needed".


### Getting rid of sites that don't converge
Model above fails to converge because of small numbers at a few of the sites, so will run on new dataframe and get rid of the patients at sites which did not converge in the above model (sites 14, 17, 26, 29, 42)
```{r}
dnamb <- dnam %>% filter(!is.na(SO4_1yrPreSamp))
```

```{r}
dnamb <- dnamb %>% filter(!is.na(fvc_pct) | !is.na(dlco_pct))
dnamb <- dnamb %>% filter(!(site=="9" | site=="13" | site=="14" | site=="15" | site=="17" | site=="23" | site=="26" | site=="29" | site=="42"))
dnamb$site <- droplevels(dnamb$site) 
```


```{r}
dnam_model2 <- lm(prop_5mC ~ SO4_1yrPreSamp + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, dnamb)
summary(dnam_model2)
confint(dnam_model2)  
```

```{r}
surv_model2 <- survreg(Surv(time_DeathTxCensor_survreg, deadORtx==1) ~ SO4_1yrPreSamp + prop_5mC + age_dx + sex + smokeHx + dich_Race + site + fvc_pct + dlco_pct, data=dnamb)
summary(surv_model2)
```

```{r}
set.seed(1000)
med2 <- mediate(dnam_model2, surv_model2, treat="SO4_1yrPreSamp", mediator="prop_5mC")
summary(med2)
```
Despite all these modifications, the PFF models fail to work using this approach. The error reported is "Error in if (xhat == 0) out <- 1 else { : missing value where TRUE/FALSE needed"


### Region rather than site
Will attempt to change site to region as this might be the issue we are running into with too many degrees of freedom.
```{r}
dnam_model3 <- lm(prop_5mC ~ SO4_1yrPreSamp + age_dx + sex + smokeHx + dich_Race + region + fvc_pct + dlco_pct, dnam)
summary(dnam_model3)
confint(dnam_model3)  
```
In this model, we lose our significance with the SO4_1yrPreSamp-prop_5mC association and the direction of effect is opposite from what we saw previously, so region is probably not a good surrogate for site.

```{r}
surv_model3 <- survreg(Surv(time_DeathTxCensor_survreg, deadORtx==1) ~ SO4_1yrPreSamp + prop_5mC + age_dx + sex + smokeHx + dich_Race + region + fvc_pct + dlco_pct, data=dnam)
summary(surv_model3)
```
The SO4_1yrPreSamp-mortality association is marginal here.

```{r}
set.seed(1000)
med3 <- mediate(dnam_model3, surv_model3, treat="SO4_1yrPreSamp", mediator="prop_5mC")
summary(med3)
```
The model converges, but there is no evidence of mediaiton in this model, and in fact it goes in the opposite direction from what is expected.

### State rather than site
Will attempt to change site to state.
```{r}
dnam_model4 <- lm(prop_5mC ~ SO4_1yrPreSamp + age_dx + sex + smokeHx + dich_Race + state + fvc_pct + dlco_pct, dnam)
summary(dnam_model4)
confint(dnam_model4)  
```
In this model, we lose our significance with the SO4_1yrPreSamp-prop_5mC association and the direction of effect is opposite from what we saw previously, so region is probably not a good surrogate for site.
...
```{r}
surv_model4 <- survreg(Surv(time_DeathTxCensor_survreg, deadORtx==1) ~ SO4_1yrPreSamp + prop_5mC + age_dx + sex + smokeHx + dich_Race + state + fvc_pct + dlco_pct, data=dnam)
summary(surv_model4)
```
The SO4_1yrPreSamp-mortality association is not significant here.

```{r}
set.seed(1000)
med4 <- mediate(dnam_model4, surv_model4, treat="SO4_1yrPreSamp", mediator="prop_5mC")
summary(med4)
```
Here we run into the same error as before when we were using site, and we don't satisfy the criteria to perform the mediation analysis anyways as the SO4_1yrPreSamp-mortality association is not significant in the above model as it is in the model including site. The error reported is "Error in if (xhat == 0) out <- 1 else { : missing value where TRUE/FALSE needed"



# Example comparison of Outputs for SO4-prop_5mC association
## Beta Regression
```{r}
dnam_modela <- betareg(prop_5mC ~ SO4_1yrPreSamp + sex + age_dx + smokeHx + site, data=dnam)
summary(dnam_modela)
confint(dnam_modela)  
nobs(dnam_modela)
```
...
## Linear Model
```{r}
dnam_modelb <- lm(prop_5mC ~ SO4_1yrPreSamp + age_dx + sex + smokeHx + site, dnam)
summary(dnam_modelb)
confint(dnam_modelb)  
```
...
```{r}
dnam_modelc <- glm(prop_5mC ~ SO4_1yrPreSamp + age_dx + sex + smokeHx + site, dnam, family="quasibinomial")
summary(dnam_modelc)
confint(dnam_modelc)  
```
