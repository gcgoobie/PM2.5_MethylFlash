...
write_xlsx(PM_data, "PFF_PM25andConstituentMatching_MethylFlash_2022_07_14.xlsx")
```
...
## PM2.5 and Constituent Breakdown by Site
```{r}
group_by(dnam, site) %>%
  summarise(
    count = n(),
    median = median(PM_1yrPreSamp, na.rm = TRUE),
    quantile = quantile(PM_1yrPreSamp, probs=c(0.25), na.rm = TRUE),
    quantile2 = quantile(PM_1yrPreSamp, probs=c(0.75), na.rm = TRUE)
  )
group_by(dnam, site) %>%
  summarise(
    count = n(),
    median = median(SO4_1yrPreSamp, na.rm = TRUE),
    quantile = quantile(SO4_1yrPreSamp, probs=c(0.25), na.rm = TRUE),
    quantile2 = quantile(SO4_1yrPreSamp, probs=c(0.75), na.rm = TRUE)
  )
group_by(dnam, site) %>%
  summarise(
    count = n(),
    median = median(NO3_1yrPreSamp, na.rm = TRUE),
    quantile = quantile(NO3_1yrPreSamp, probs=c(0.25), na.rm = TRUE),
    quantile2 = quantile(NO3_1yrPreSamp, probs=c(0.75), na.rm = TRUE)
  )
group_by(dnam, site) %>%
  summarise(
    count = n(),
    median = median(NH4_1yrPreSamp, na.rm = TRUE),
    quantile = quantile(NH4_1yrPreSamp, probs=c(0.25), na.rm = TRUE),
    quantile2 = quantile(NH4_1yrPreSamp, probs=c(0.75), na.rm = TRUE)
  )
group_by(dnam, site) %>%
  summarise(
    count = n(),
    median = median(BC_1yrPreSamp, na.rm = TRUE),
    quantile = quantile(BC_1yrPreSamp, probs=c(0.25), na.rm = TRUE),
    quantile2 = quantile(BC_1yrPreSamp, probs=c(0.75), na.rm = TRUE)
  )
group_by(dnam, site) %>%
  summarise(
    count = n(),
    median = median(OM_1yrPreSamp, na.rm = TRUE),
    quantile = quantile(OM_1yrPreSamp, probs=c(0.25), na.rm = TRUE),
    quantile2 = quantile(OM_1yrPreSamp, probs=c(0.75), na.rm = TRUE)
  )
  group_by(dnam, site) %>%
  summarise(
    count = n(),
    median = median(SS_1yrPreSamp, na.rm = TRUE),
    quantile = quantile(SS_1yrPreSamp, probs=c(0.25), na.rm = TRUE),
    quantile2 = quantile(SS_1yrPreSamp, probs=c(0.75), na.rm = TRUE)
  )
  group_by(dnam, site) %>%
  summarise(
    count = n(),
    median = median(Soil_1yrPreSamp, na.rm = TRUE),
    quantile = quantile(Soil_1yrPreSamp, probs=c(0.25), na.rm = TRUE),
    quantile2 = quantile(Soil_1yrPreSamp, probs=c(0.75), na.rm = TRUE)
  )
```
...
```{r}
  ...
  summarise(
    count = n(),
    median = median(pct_5mC, na.rm = TRUE),
    quantile = quantile(pct_5mC, probs=c(0.25), na.rm = TRUE),
    quantile2 = quantile(pct_5mC, probs=c(0.75), na.rm = TRUE)
  )
...
(dnamb %>% ggplot(aes(x=region, y=PM_1yrPreSamp, fill=region))+
    geom_boxplot(width=0.2, color="black", alpha=1.0)+
    geom_violin(width=1.0, alpha=0.5)+
    labs(x="Region of U.S.", y="PM2.5 in 1yr Pre-Sampling", title="PM2.5 in 1yr Pre-Sampling by Region")+
    theme_light()+
    theme(legend.position = "none", plot.title = element_text(hjust = 0.5)))
```
...
(dnamb %>% ggplot(aes(x=region, y=SO4_1yrPreSamp, fill=region))+
    geom_boxplot(width=0.2, color="black", alpha=1.0)+
    geom_violin(width=1.0, alpha=0.5)+
    labs(x="Region of U.S.", y="SO4 in 1yr Pre-Sampling", title="SO4 in 1yr Pre-Sampling by Region")+
    theme_light()+
    theme(legend.position = "none", plot.title = element_text(hjust = 0.5)))
```
...
(dnamb %>% ggplot(aes(x=region, y=NO3_1yrPreSamp, fill=region))+
    geom_boxplot(width=0.2, color="black", alpha=1.0)+
    geom_violin(width=1.0, alpha=0.5)+
    labs(x="Region of U.S.", y="NO3 in 1yr Pre-Sampling", title="NO3 in 1yr Pre-Sampling by Region")+
    theme_light()+
    theme(legend.position = "none", plot.title = element_text(hjust = 0.5)))
```
...
(dnamb %>% ggplot(aes(x=region, y=NH4_1yrPreSamp, fill=region))+
    geom_boxplot(width=0.2, color="black", alpha=1.0)+
    geom_violin(width=1.0, alpha=0.5)+
    labs(x="Region of U.S.", y="NH4 in 1yr Pre-Sampling", title="NH4 in 1yr Pre-Sampling by Region")+
    theme_light()+
    theme(legend.position = "none", plot.title = element_text(hjust = 0.5)))
```
...
(dnamb %>% ggplot(aes(x=region, y=BC_1yrPreSamp, fill=region))+
    geom_boxplot(width=0.2, color="black", alpha=1.0)+
    geom_violin(width=1.0, alpha=0.5)+
    labs(x="Region of U.S.", y="BC in 1yr Pre-Sampling", title="BC in 1yr Pre-Sampling by Region")+
    theme_light()+
    theme(legend.position = "none", plot.title = element_text(hjust = 0.5)))
```
...
(dnamb %>% ggplot(aes(x=region, y=OM_1yrPreSamp, fill=region))+
    geom_boxplot(width=0.2, color="black", alpha=1.0)+
    geom_violin(width=1.0, alpha=0.5)+
    labs(x="Region of U.S.", y="OM in 1yr Pre-Sampling", title="OM in 1yr Pre-Sampling by Region")+
    theme_light()+
    theme(legend.position = "none", plot.title = element_text(hjust = 0.5)))
```
...
(dnamb %>% ggplot(aes(x=region, y=SS_1yrPreSamp, fill=region))+
    geom_boxplot(width=0.2, color="black", alpha=1.0)+
    geom_violin(width=1.0, alpha=0.5)+
    labs(x="Region of U.S.", y="SS in 1yr Pre-Sampling", title="SS in 1yr Pre-Sampling by Region")+
    theme_light()+
    theme(legend.position = "none", plot.title = element_text(hjust = 0.5)))
```
...
(dnamb %>% ggplot(aes(x=region, y=Soil_1yrPreSamp, fill=region))+
    geom_boxplot(width=0.2, color="black", alpha=1.0)+
    geom_violin(width=1.0, alpha=0.5)+
    labs(x="Region of U.S.", y="Soil in 1yr Pre-Sampling", title="Soil in 1yr Pre-Sampling by Region")+
    theme_light()+
    theme(legend.position = "none", plot.title = element_text(hjust = 0.5)))
```
...
Complete model with site
```{r}
dnam_model3 <- betareg(prop_5mC ~ SS1moSamp_dich + sex + age_dx + smokeHx + site, data=dnam, na.rm=T)
summary(dnam_model3)
confint(dnam_model3) 
nobs(dnam_model3)
```
