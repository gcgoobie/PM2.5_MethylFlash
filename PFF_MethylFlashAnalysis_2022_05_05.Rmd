...
## Region of the U.S.
```{r}
dnam$site <- as.factor(dnam$state)
dnam <- dnam %>% mutate(region=case_when(state %in% c("CA", "CO", "ID", "MT", "OR", "UT", "WA") ~ "West",
                          ...
                          #if_else(state==c("CA" , "CO" , "ID" , "MT" , "OR" , "UT" , "WA"), "West", 
                           #            if_else(state==c("TX" , "AZ" , "NV" , "NM"), "Southwest",
                            #                   if_else(state==c("IL" , "IA" , "IN" , "KS" , "MI" , "MN" , "MO" , "ND" , "NE" , "OH" , "SD" , "WI"), "Midwest",
                             #                         if_else(state==c("CN" , "DC" , "DE" , "MA" , "MD" , "ME" , "NH" , "NJ" , "NY" , "PA" , "RI" , "VT"), "Northeast", "Southeast")))))
```
