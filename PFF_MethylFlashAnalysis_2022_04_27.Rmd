...
```{r}
outfile1 <- here("PFF_Results/PFF_MethylFlash_ExptID_1-738_Combined_2022_04_26.xlsx")
...
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_5yrPreSamp, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_5yrPreSamp + sex, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_5yrPreSamp + age_dx, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_5yrPreSamp + smokeHx, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_5yrPreSamp + dich_Race, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_5yrPreSamp + metro, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
```{r}
dnam_model2 <- lm(pct_5mC ~ PM_5yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between PM_5yrPreSamp and pct_5mC in this model.


Complete model with age_dx, sex, smokeHx, race, urbanicity
```{r}
dnam_model3 <- lm(pct_5mC ~ PM_5yrPreSamp + sex + age_dx + smokeHx + dich_Race + metro, data=dnam)
summary(dnam_model3)
confint(dnam_model3)
```
No significant association between PM_5yrPreSamp and pct_5mC in this model.
...
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_1yrPreSamp, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
Impact of sex on model
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_1yrPreSamp + sex, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
Impact of age_dx on model
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_1yrPreSamp + age_dx, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
Impact of smokeHx on model
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_1yrPreSamp + smokeHx, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
Impact of race on model
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_1yrPreSamp + dich_Race, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
Impact of urbanicity on model
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_1yrPreSamp + metro, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
Partial model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ PM_1yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between PM_1yrPreSamp and pct_5mC in this model.


Complete model with age_dx, sex, smokeHx, race, urbanicity
```{r}
dnam_model3 <- lm(pct_5mC ~ PM_1yrPreSamp + sex + age_dx + smokeHx + dich_Race + metro, data=dnam)
summary(dnam_model3)
confint(dnam_model3)
```
No significant association between PM_1yrPreSamp and pct_5mC in this model.
...
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_6moPreSamp, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between PM_6moPreSamp and pct_5mC in this model.

Partial model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ PM_6moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between PM_6moPreSamp and pct_5mC in this model.
...
Complete model with age_dx, sex, smokeHx, race, urbanicity
```{r}
dnam_model3 <- lm(pct_5mC ~ PM_6moPreSamp + sex + age_dx + smokeHx + dich_Race + metro, data=dnam)
summary(dnam_model3)
confint(dnam_model3)
```
No significant association between PM_6moPreSamp and pct_5mC in this model.
...
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_3moPreSamp, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between PM_3moPreSamp and pct_5mC in this model.

Partial model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ PM_3moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between PM_3moPreSamp and pct_5mC in this model.
...
Complete model with age_dx, sex, smokeHx, race, urbanicity
```{r}
dnam_model3 <- lm(pct_5mC ~ PM_3moPreSamp + sex + age_dx + smokeHx + dich_Race + metro, data=dnam)
summary(dnam_model3)
confint(dnam_model3)
```
No significant association between PM_3moPreSamp and pct_5mC in this model.
...
```{r}
dnam_model1 <- lm(pct_5mC ~ PM_1moPreSamp, dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between PM_1moPreSamp and pct_5mC in this model.

Partial model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ PM_1moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between PM_1moPreSamp and pct_5mC in this model.
...
Complete model with age_dx, sex, smokeHx, race, urbanicity
```{r}
dnam_model3 <- lm(pct_5mC ~ PM_1moPreSamp + sex + age_dx + smokeHx + dich_Race + metro, data=dnam)
summary(dnam_model3)
confint(dnam_model3)
```
No significant association between PM_1moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ SO4_5yrPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between SO4_5yrPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ SO4_5yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between SO4_5yrPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ SO4_1yrPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between SO4_1yrPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ SO4_1yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between SO4_1yrPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ SO4_6moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between SO4_6moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ SO4_6moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between SO4_6moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ SO4_3moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between SO4_3moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ SO4_3moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between SO4_3moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ SO4_1moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between SO4_1moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ SO4_1moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between SO4_1moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ NO3_5yrPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
**Nitrate is significantly associated with higher global DNAm in this base model.**

Adjuted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ NO3_5yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
**Nitrate is significantly associated with higher global DNAm in this model.**

### Continuous NO3 in 1yrs Pre-Sampling
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ NO3_1yrPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ NO3_1yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
**Higher nitrate is associated with higher global DNAm in this model.**
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ NO3_6moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
**Higher nitrate is associated with higher global DNAm in this model.**
...
Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ NO3_6moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
**Higher nitrate is associated with higher global DNAm in this model.**
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ NO3_3moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ NO3_3moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No association between nitrate and global DNAm in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ NO3_1moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No association between nitrate and global DNAm in this model.
...
Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ NO3_1moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No association between nitrate and global DNAm in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ NH4_5yrPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
**Higher NH4 significantly associated with higher global DNAm in this model.**

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ NH4_5yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
**Higher NH4 significantly associated with higher global DNAm in this model.**
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ NH4_1yrPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ NH4_1yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
*Higher NH4 marginally associated with higher global DNAm in this model.*
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ NH4_6moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
...
Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ NH4_6moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
Higher NH4 not associated with global DNAm in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ NH4_3moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
Higher NH4 not associated with global DNAm in this model.
...
Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ NH4_3moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
Higher NH4 not associated with global DNAm in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ NH4_1moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
Higher NH4 not associated with global DNAm in this model.
...
Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ NH4_1moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
Higher NH4 not associated with global DNAm in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ BC_5yrPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between BC_5yrPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ BC_5yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between BC_5yrPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ BC_1yrPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between BC_1yrPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ BC_1yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between BC_1yrPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ BC_6moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between BC_6moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ BC_6moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between BC_6moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ BC_3moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between BC_3moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ BC_3moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between BC_3moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ BC_1moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between BC_1moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ BC_1moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between BC_1moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ OM_5yrPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between OM_5yrPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ OM_5yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between OM_5yrPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ OM_1yrPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between OM_1yrPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ OM_1yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between OM_1yrPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ OM_6moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between OM_6moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ OM_6moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between OM_6moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ OM_3moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between OM_3moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ OM_3moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between OM_3moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ OM_1moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between OM_1moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ OM_1moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between OM_1moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ SS_5yrPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between SS_5yrPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ SS_5yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between SS_5yrPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ SS_1yrPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between SS_1yrPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ SS_1yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between SS_1yrPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ SS_6moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between SS_6moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ SS_6moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between SS_6moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ SS_3moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between SS_3moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ SS_3moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between SS_3moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ SS_1moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between SS_1moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ SS_1moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between SS_1moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ Soil_5yrPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between Soil_5yrPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ Soil_5yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between Soil_5yrPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ Soil_1yrPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between Soil_1yrPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ Soil_1yrPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between Soil_1yrPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ Soil_6moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between Soil_6moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ Soil_6moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between Soil_6moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ Soil_3moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between Soil_3moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ Soil_3moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between Soil_3moPreSamp and pct_5mC in this model.
...
Unadjusted model
```{r}
dnam_model1 <- lm(pct_5mC ~ Soil_1moPreSamp, data=dnam)
summary(dnam_model1)
confint(dnam_model1)
```
No significant association between Soil_1moPreSamp and pct_5mC in this model.

Adjusted model with age_dx, sex, smokeHx
```{r}
dnam_model2 <- lm(pct_5mC ~ Soil_1moPreSamp + sex + age_dx + smokeHx, data=dnam)
summary(dnam_model2)
confint(dnam_model2)
```
No significant association between Soil_1moPreSamp and pct_5mC in this model.
